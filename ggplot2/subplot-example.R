...
p5 <- ggplot(df, aes(x)) + stat_function(fun = dnorm) + labs(title = "normal") + ylim(0, 0.5)
p6 <- ggplot(df, aes(x)) + stat_function(fun = dlogis) + labs(title = "logistic") + ylim(0, 0.5)
p7 <- ggplot(df, aes(x)) + stat_function(fun = pnorm) + labs(title = "normal (cdf)")
p8 <- ggplot(df, aes(x)) + stat_function(fun = plogis) + labs(title = "logistic (cdf)")
