...
# Hist & density
g <- ggplot(iris, aes(x = Sepal.Length, y = ..density.., fill = Species, colour = Species)) +
  geom_histogram(alpha = 0.3, position = "identity", size = 1) +
...
g <- ggplot(volcano3d, aes(x = x, y = y, z = z)) +
